...
$sql = "SELECT * FROM raw_volume ORDER BY time_start DESC LIMIT 100";
      ...
      <?php if ($result && $result->num_rows > 0): ?>
        <?php while ($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td data-label="Volume"><?= $row['volume_15min'] ?></td>
          </tr>
        <?php endwhile; ?>
      <?php else: ?>
